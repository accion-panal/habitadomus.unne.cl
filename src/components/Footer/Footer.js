                ...
                <div className="d-flex flex-col text-md text-gray-800 mt-5">
                  <div className="flex justify-start items-center my-3">
                    <a
                      ...
                      target='_blank'
                      className="text-dark bg-primary-ligth text-white hover:scale-110 hover:border-primary duration-300 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                      <svg
                        width="8"
                        height="16"

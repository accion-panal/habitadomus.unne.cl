        ...
        <div className='grid grid-cols-1 xl:grid-cols-2'>
          ...
          <div className="col-span-2 xl:col-span-1 ">
            <p className="text-lg xl:text-xl text-gray-700 mt-8 ml-0 xl:ml-1 xl:text-left">
              Me certifiqué en Corretaje de Propiedades por Learning Group en el año 2012, en la ciudad de Antofagasta. 
              Desde entonces, he ejercido como corredor de propiedades hasta mi traslado en 2015 a la V región, 
              donde continúo desarrollando mi carrera de manera activa hasta la fecha. Con una trayectoria profesional 
              de 12 años en el ámbito del corretaje y la administración de propiedades, poseo un amplio conocimiento y 
              experiencia en el sector, respaldando así mi capacidad para brindar un servicio de calidad y eficiencia a mis clientes.
              <br />
            </p>
            ...
            <p className="text-xl xl:text-xl text-gray-700 ml-0 xl:ml-1 md:text-center xl:text-left">
              Fundador y Gerente General de Habitadomus Propiedades.
            </p>
          </div>
        </div>
      </div>
